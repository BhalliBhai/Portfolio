...
const Portfolio = () =>{
     return(
         ...
         <Navbar/>
            ...
            <h1 className='text-success'> It's Portfolio Page</h1>
            </div> */}


            {/* <!-- ======= Portfolio Section ======= --> */}
  <section id="portfolio" className="portfolio mt-3">
      ...
      <div className="row portfolio-container">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-app">
          ...
          //    src="assets/img/portfolio/portfolio-1.jpg" 
            src={require('../img/portfolio/portfolio-1.jpg')} className="img-fluid" alt="img1"/>
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-web">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-2.jpg')} className="img-fluid" alt="img2"/>
            <div className="portfolio-info">
              <h4>Web 3</h4>
              <p>Web</p>
              <div className="portfolio-links">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-app">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-3.jpg')} className="img-fluid" alt="img3"/>
            <div className="portfolio-info">
              <h4>App 2</h4>
              <p>App</p>
              <div className="portfolio-links">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-card">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-4.jpg')} className="img-fluid" alt="img4"/>
            <div className="portfolio-info">
              <h4>Card 2</h4>
              <p>Card</p>
              <div className="portfolio-links">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-web">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-5.jpg')} className="img-fluid" alt="img5"/>
            <div className="portfolio-info">
              <h4>Web 2</h4>
              <p>Web</p>
              <div className="portfolio-links">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-app">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-6.jpg')} className="img-fluid" alt="img6"/>
            <div className="portfolio-info">
              <h4>App 3</h4>
              <p>App</p>
              <div className="portfolio-links">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-card">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-7.jpg')} className="img-fluid" alt="img7"/>
            <div className="portfolio-info">
              <h4>Card 1</h4>
              <p>Card</p>
              <div className="portfolio-links">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-card">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-8.jpg')} className="img-fluid" alt="img8"/>
            <div className="portfolio-info">
              <h4>Card 3</h4>
              <p>Card</p>
              <div className="portfolio-links">
        ...
        <div className="col-lg-4 col-md-6 portfolio-item filter-web">
          <div className="portfolio-wrap">
            <img src={require('../img/portfolio/portfolio-9.jpg')} className="img-fluid" alt="img9"/>
            <div className="portfolio-info">
              <h4>Web 3</h4>
              <p>Web</p>
              <div className="portfolio-links">
